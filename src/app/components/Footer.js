    ...
    <div className="bg-white dark:bg-gray-800 px-4 pt-4 mx-auto w-full">
        ...
        <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-2 text-sm">
            ...
            <div className="flex">
              ...
              <Link
                ...
                title="Our phone"
                className="transition-colors duration-300 text-gray-800 dark:text-gray-200"
              >
                850-123-5021
              </Link>
            </div>
          ...
          <div>
            ...
            <div className="flex items-center mt-1 space-x-3">
              <Link
                href="/"
                className="text-gray-500 dark:text-gray-200 transition-colors duration-300 hover:text-deep-purple-accent-400"
              >
            ...
            <div className="flex flex-col justify-start mt-6 space-y-3 md:space-y-0 md:flex-row">
              <input
                id="email"
                type="text"
                className="md:w-48 px-4 py-2 text-gray-700 bg-white border rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:outline-none focus:ring focus:ring-opacity-40 focus:ring-blue-300"
      ...
      <div className="flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row">
        <p className="text-sm text-gray-600 dark:text-gray-200">
          © Copyright 2024 Hashtags. All rights reserved.
        </p>
        <ul className="flex flex-col mb-3 space-y-2 lg:mb-0 sm:space-y-0 sm:space-x-5 sm:flex-row">
          <li>
            <Link
              href="/"
              className="text-sm text-gray-600 dark:text-gray-200 transition-colors duration-300 hover:text-deep-purple-accent-400"
            >
              F.A.Q
            </Link>
          </li>
